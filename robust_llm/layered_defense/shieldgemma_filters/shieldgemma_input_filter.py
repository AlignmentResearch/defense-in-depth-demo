...
@ComponentRegistry.register("ShieldGemmaInputFilter")
class ShieldGemmaInputFilter(InputComponent):
    def __init__(
        self,
        ...
        """Initialize a ShieldGemma input filter."""
