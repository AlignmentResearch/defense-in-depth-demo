...
@ComponentRegistry.register("LlamaGuard4OutputFilter")
class LlamaGuard4OutputFilter(OutputComponent):
    """Output filter that flags if the text is a jailbreak using LlamaGuard4.
    ...
    def __call__(
        ...
        """
        # N.B. LlamaGuard only looks at the last message.
        assert all(
        ...
        texts = [
            format_output_messages(message_list, self.tokenizer)
