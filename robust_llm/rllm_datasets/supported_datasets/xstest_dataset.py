...
@RLLMDataset.register_dataset("AlignmentResearch/XSTest")
class XSTestDataset(RLLMDataset):
    """StrongREJECT dataset for robust LLM experiments."""

    @property
    @override
    def num_classes(self) -> int:
        """The XSTest dataset has two classes:
    ...
    def modifiable_chunk_spec(self) -> ModifiableChunkSpec:
        """The XSTest dataset consists of three chunks:
