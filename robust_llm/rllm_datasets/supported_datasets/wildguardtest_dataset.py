...
@RLLMDataset.register_dataset("AlignmentResearch/WildGuardTest")
class WildGuardTestDataset(RLLMDataset):
    """WildGuardTest dataset for robust LLM experiments."""

    @property
    @override
    def num_classes(self) -> int:
        """The WildGuardTest dataset has two classes:
    ...
    def modifiable_chunk_spec(self) -> ModifiableChunkSpec:
        """The WildGuardTest dataset consists of three chunks:
